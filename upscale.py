...
def upscale_image(input_dir, out_dir, model_name, tile_num, use_path, save_image):
    ...
    if face_enhance_e:  # Use GFPGAN for face enhancement
    ...
    for idx, path in enumerate(paths):
        ...
        try:
            ...
            print('Error', error)
            print('If you encounter CUDA out of memory, try to set Upscale_tile with a smaller number. 800 or smaller')
        else:
            if ext == 'auto':
